...
class Query:
    ...
    oper2func['_le'] = lambda b: lambda x: operator.le(x, b)
    oper2func['_ne'] = lambda b: lambda x: operator.ne(x, b)
    oper2func['_ge'] = lambda b: lambda x: operator.ge(x, b)
    oper2func['_gt'] = lambda b: lambda x: operator.gt(x, b)
    oper2func['_in'] = lambda b: lambda x: operator.contains(b, x)
    oper2func['_nin'] = lambda b: lambda x: not operator.contains(b, x)
